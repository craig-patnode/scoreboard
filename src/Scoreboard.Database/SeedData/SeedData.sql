...
VALUES
    (1, 'A1B2C3D4-E5F6-4A5B-8C9D-0E1F2A3B4C5D', 'F1E2D3C4-B5A6-4D5E-8F9A-0B1C2D3E4F5A', N'Craig Patnode', 'craig@scoreboard.live', 'PLACEHOLDER_HASH', 2, 1, 1, 1),
    (2, 'B2C3D4E5-F6A7-4B5C-9D0E-1F2A3B4C5D6E', 'A2B3C4D5-E6F7-4C5D-0E1F-2A3B4C5D6E7F', N'Dave Brown',    'dave@scoreboard.live',  'PLACEHOLDER_HASH', 2, 1, 1, 1);
